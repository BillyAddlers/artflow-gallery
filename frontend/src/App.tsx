...
function App() {
    ...
    useEffect(() => {
        fetch('http://localhost:6969/api/users/1708322625598682600')
            .then((res) => res.json())
            .then((data) => {
                console.log(data);
                setPosts(data);
                  ...
                  <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                      <a href="" className="flex items-center">
                          <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9"
                               alt="Flowbite Logo"/>
                          <span
                              className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Artflow Gallery</span>
                      </a>
